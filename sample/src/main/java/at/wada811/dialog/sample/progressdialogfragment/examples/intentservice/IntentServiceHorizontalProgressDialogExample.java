 ...
 */
public class IntentServiceHorizontalProgressDialogExample extends ProgressDialogFragmentExample{

    private Context context;
    private ProgressDialogFragment dialogFragment;

    public IntentServiceHorizontalProgressDialogExample(Context context){
        super(context.getString(R.string.example_horizontal_progress_dialog_with_intent_service));
