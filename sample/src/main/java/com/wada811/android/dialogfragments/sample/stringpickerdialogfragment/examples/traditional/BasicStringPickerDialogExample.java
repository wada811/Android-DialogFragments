...
package com.wada811.android.dialogfragments.sample.stringpickerdialogfragment.examples.traditional;
...
public class BasicStringPickerDialogExample extends Example {
    ...
    public BasicStringPickerDialogExample(){
        super(BasicStringPickerDialogExample.class.getSimpleName() + "(Traditional)");
    }
