...
import at.wada811.android.dialogfragments.StringPicker;
...
public interface DialogFragmentCallback {
     ...
     */
    public void onDateSet(DialogFragmentInterface dialog, DatePicker datePicker, int year, int monthOfYear, int dayOfMonth);
     ...
     */
    public void onTimeSet(DialogFragmentInterface dialog, TimePicker timePicker, int hourOfDay, int minute);
